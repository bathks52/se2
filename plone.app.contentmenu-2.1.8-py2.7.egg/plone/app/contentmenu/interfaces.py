...
class IAccessibilityCheckerSubMenuItem(IBrowserSubMenuItem):
    """The menu item linking to the accessibility checker menu.
    """


class IAccessibilityCheckerMenu(IBrowserMenu):
    """The accessibility checker menu.
